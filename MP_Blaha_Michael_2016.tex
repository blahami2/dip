...
data <- c()
for(i in 5000:10000){
  data <- c(data, data1$Tablet[[i]] + data3$Tablet[[i]] + 
                  data4$Tablet[[i]]+ data5$Tablet[[i]])  
}
barplot(data)
\endtt

This is just an illustrative plot to see the ratio of time looking at the application (the black area of the plot) and not looking at the application (the white area of the plot).
