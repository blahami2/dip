...
As another important metric, the maximal glance time (the longest continuous time interval spent looking at the application) measured for Torque was in range from 308 to 388 milliseconds with the mean of 303.2 and a standard deviation of 68.67.
...
%\clabel[tables.testing.ab]
%\table{||c||c|c|c|c||}{\crll
%   &\multicolumn{2}{|c|}{Torque}  & \multicolumn{2}{|c|}{CarDashboard}  \crll
%  \bf Participant & \bf Glance ratio & \bf Max glance time & \bf Glance ratio & \bf Max glance time \crll
%  P1 &1 & 1 & 1 & 1 \crli
% Average &1 & 1 & 1 & 1  \crll
%}\caption/f A/B testing
%\medskip
