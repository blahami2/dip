...
\rfc{fix}
Car Dashboard application enables users to use their android tablet or phone safely while driving. While focusing on usability and minimizing the cognitive load, this application offers rich variety of use cases in a simple but attractive design.
