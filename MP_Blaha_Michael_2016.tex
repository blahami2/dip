...
%----------------------------------------------------------------------- INTRODUCTION ------------------------------------------------------------------------%
\chap Introduction TODO\label[introduction]
...
%	------------------------------------------------------------------------ Project ----------------------------------------------------------------------%
\sec Project TODO\label[introduction.project]

See above

%		------------------------------------------------------------------------ Motivation ----------------------------------------------------------------------%
\secc Motivation TODO\label[introduction.motivation]

See above

%	------------------------------------------------------------------------ Assignment analysis ----------------------------------------------------------------------%
\sec Assignment analysis\label[introduction.assignment_analysis]
...
%------------------------------------------------------------------------ ANALYSIS ------------------------------------------------------------------------%
\chap Analysis TODO\label[analysis]
...
\sec Existing applications\label[analysis-existing_applications]


\secc Applications TODO\label[analysis-existing_applications-applications]
...
\secc Torque \label[analysis-existing_applications-torque]
...
\secc CarHome Ultra \label[analysis-existing_applications-carhome_ultra]
...
\secc Car Dashdroid \label[analysis-existing_applications-car_dashdroid]
...
\secc Ultimate Car Dock \label[analysis-existing_applications-ultimate_car_dock]
...
\secc Conclusion \label[analysis-existing_applications-conclusion]
...
\secc Android Auto \label[analysis-existing_applications-android_auto]
...
%	------------------------------------------------------------------------ Use cases ----------------------------------------------------------------------%
\sec Use-cases\label[analysis-use_cases]

Based on above. Also other typical analysis stuff.

%	------------------------------------------------------------------------ Platforms ----------------------------------------------------------------------%
\sec Platforms\label[analysis-platforms]
...
\secc Android\label[analysis-platforms-android]
...
\secc iOS\label[analysis-platforms-ios]
...
\secc Windows\label[analysis-platforms-windows]
...
\secc Conclusion\label[analysis-platforms-conclusion]
...
%	------------------------------------------------------------------------ Android platform ----------------------------------------------------------------------%
\sec Android platform TODO\label[analysis-android_platform]
...
\secc Performance\label[analysis-android_platform-performance]
...
\secc Architecture\label[analysis-android_platform-architecture]
...
\secc Material design\label[analysis-android_platform-material_design]

%------------------------------------------------------------------------ GUI ----------------------------------------------------------------------%
\sec GUI TODO\label[analysis-gui]


\secc Basic principles\label[analysis-gui-basic_principles]
...
\secc UI in a car environment\label[analysis-gui-ui_in_a_car_environment]
...
\sec Development and support tools TODO\label[analysis-development_and_support_tools]


\secc Development environment\label[analysis-development_and_support_tools-ide]
...
\secc Version control system\label[analysis-development_and_support_tools-vcs]
...
\secc Test driven development\label[analysis-development_and_support_tools-tdd]
...
\secc Continuous integration\label[analysis-development_and_support_tools-ci]
...
\sec On-Board Diagnostics TODO\label[analysis-obd]
...
\secc API TODO\label[analysis-obd-api]



\secc Data TODO\label[analysis-obd-data]


%------------------------------------------------------------------------ DESIGN ------------------------------------------------------------------------%
\chap Design TODO\label[design]


%	------------------------------------------------------------------------ Application architecture ----------------------------------------------------------------------%
\sec Application architecture TODO\label[design-application_architecture]
...
\secc Platform limitations\label[design-application_architecture-platform_limitations]
...
\secc Extensibility\label[design-application_architecture-extensibility]
...
\secc Modularity TODO\label[design-application_architecture-modularity]
...
\secc Adaptability\label[design-application_architecture-adaptability]
...
\secc Android Auto preparation TODO\label[design-application_architecture-android_auto_preparation]




%	------------------------------------------------------------------------ GUI ----------------------------------------------------------------------%
\sec GUI TODO\label[design-gui]
...
\secc Basic elements TODO\label[design-gui.basic_elements]

Basic idea

\secc Drafts TODO\label[design-gui-drafts]

\secc The early phase TODO\label[design-gui-the_early_phase]
...
\secc The second phase TODO\label[design-gui-the_second_phase]
...
\secc The grid\label[design-gui-the_grid]
...
\secc The final design\label[design-gui-the_final_design]
...
%------------------------------------------------------------------------ REALIZATION ------------------------------------------------------------------------%
\chap Realization TODO\label[realization]


%	------------------------------------------------------------------------ Preparation ----------------------------------------------------------------------%
\sec Preparation TODO\label[realization-preparation]


\secc Environment TODO\label[realization-preparation-environment]


\secc Versioning TODO\label[realization-preparation-versioning]


\secc Testing TODO\label[realization-preparation-testing]


\secc Scripting TODO\label[realization-preparation-scripting]


%	------------------------------------------------------------------------ Core ----------------------------------------------------------------------%
\sec Core TODO\label[realization-core]


\secc Core TODO\label[realization-core-core]


\secc Data storage TODO\label[realization-core-data_storage]


\secc Communication TODO\label[realization-core-communication]


\secc Optimization TODO\label[realization-core-optimization]


%	------------------------------------------------------------------------ Modularity ----------------------------------------------------------------------%
\sec Modularity TODO\label[realization-modularity]


\secc Requirements TODO\label[realization-modularity-requirements]


\secc Integration TODO\label[realization-modularity-integration]


%	------------------------------------------------------------------------ GUI ----------------------------------------------------------------------%
\sec GUI TODO\label[realization-gui]

GUI implementation based on the design! Implementing modules, color, responsive effects

\secc Common elements TODO\label[realization-gui-common_elements]

Hierarchical model, effects, submenus

\secc Multiple designs TODO\label[realization-gui-multiple_designs]

Limited set of module types

%------------------------------------------------------------------------ TESTING ------------------------------------------------------------------------%
\chap Testing TODO\label[testing]

Brag about TDD, CI and Simulator!

%	------------------------------------------------------------------------ Implementation ----------------------------------------------------------------------%
\sec Code TODO\label[testing-code]

Describe testing code, common testing (look\&see, etc.)

\secc Unit testing TODO\label[testing-code-unit_testing]
...
\secc Integration testing TODO\label[testing-code-integration_testing]

Instrumentation? Describe TDD, CI, automation

\secc System testing TODO\label[testing-code-system_testing]

Server testing, consider removing

\secc Qualification testing TODO\label[testing-code-qualification_testing]

Testing with users - consider section on its own - testing application as a whole thing

%	------------------------------------------------------------------------ GUI ----------------------------------------------------------------------%
\sec GUI TODO\label[testing-gui]


\secc Heuristic testing TODO\label[testing-gui-heuristic_testing]
...
\secc Testing with users TODO\label[testing-gui-testing_with_users]
...
%	------------------------------------------------------------------------ Summary ----------------------------------------------------------------------%
\sec Summary TODO\label[testing-summary]


%------------------------------------------------------------------------ CONCLUSION ------------------------------------------------------------------------%
\chap Conclusion TODO\label[conclusion]


%	------------------------------------------------------------------------ Assignment completion ----------------------------------------------------------------------%
\sec Assignment completion TODO\label[conclusion-assignment_completion]


%	------------------------------------------------------------------------ Project life cycle ----------------------------------------------------------------------%
\sec Project life cycle TODO\label[conclusion-project_life_cycle]


\secc Present TODO\label[conclusion-project_life_cycle-present]


\secc Future TODO\label[conclusion-project_life_cycle-future]


%	------------------------------------------------------------------------ Summary ----------------------------------------------------------------------%
\sec Summary TODO\label[conclusion-summary]
